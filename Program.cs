...
namespace Integrador
{
	class Program
	{
		...
		SqlConnection conexion = new SqlConnection("server=DESKTOP-O1PN00U\\SQLEXPRESS; database=DBIntegrador; integrated security=true");
	}
}